...
public class CreateQuestionGUI extends JFrame {
	...
	public CreateQuestionGUI(Vector<domain.Event> v, Admin erabIzena) {
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		jComboBoxEvents.setBounds(new Rectangle(274, 61, 250, 20));
		jLabelListOfEvents.setForeground(Color.WHITE);
		jLabelListOfEvents.setBounds(new Rectangle(289, 30, 277, 20));
		jLabelQuery.setForeground(Color.WHITE);
		jLabelQuery.setBounds(new Rectangle(24, 225, 75, 20));
		jTextFieldQuery.setForeground(new Color(0, 250, 154));
		jTextFieldQuery.setCaretColor(new Color(0, 250, 154));
		jTextFieldQuery.setBorder(null);
		jTextFieldQuery.setBackground(new Color(57, 62, 70));
		jTextFieldQuery.setBounds(new Rectangle(99, 225, 429, 20));
		jCalendar.getDayChooser().setDecorationBackgroundColor(new Color(57, 62, 70));
		jCalendar.getDayChooser().setForeground(Color.WHITE);
		jCalendar.getDayChooser().setWeekOfYearVisible(false);
		jCalendar.getDayChooser().setWeekdayForeground(Color.WHITE);
		jCalendar.getDayChooser().getDayPanel().setBackground(new Color(57, 62, 70));
		jCalendar.getDayChooser().getDayPanel().setBorder(null);
		jCalendar.setForeground(Color.BLACK);
		jCalendar.setBorder(null);

		jCalendar.setBounds(new Rectangle(39, 64, 225, 150));
		scrollPaneEvents.setBounds(new Rectangle(25, 44, 346, 116));
		jButtonCreate.setFont(new Font("Tahoma", Font.BOLD, 13));
		jButtonCreate.setForeground(new Color(0, 250, 154));
		jButtonCreate.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		jButtonCreate.setBorder(null);
		jButtonCreate.setBackground(new Color(57, 62, 70));

		jButtonCreate.setBounds(new Rectangle(151, 287, 250, 30));
		...
		jButtonClose.setBounds(new Rectangle(0, 0, 86, 20));
		...
		jLabelError.setBounds(new Rectangle(196, 256, 305, 20));
		...
		jLabelEventDate.setBounds(39, 30, 140, 25);
		...
		try {
			...
			if (inputQuery.length() > 0) {
				...
				// It could be to trigger an exception if the introduced string is not a number
					...
					facade.createQuestion(event, inputQuery);
